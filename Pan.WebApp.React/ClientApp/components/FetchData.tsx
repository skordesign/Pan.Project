...
class FetchData extends React.Component<WeatherForecastProps, {}> {
    ...
    private renderPagination() {
        ...
        return <p className='row auto'>
            <Link className='button col' to={ `/fetchdata/${ prevStartDateIndex }` }>Previous</Link>
            <Link className='button col' to={ `/fetchdata/${ nextStartDateIndex }` }>Next</Link>
